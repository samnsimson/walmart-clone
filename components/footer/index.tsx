...
export const Fotoer: FC<FotoerProps> = ({ ...props }) => {
    return (
        <div {...props}>
            <div className="flex flex-col items-center bg-[#e6f1fc] ">
                <section className="prose py-8 text-center">
                    ...
                    <Button
                        size="lg"
                        variant="outline"
                        className="rounded-full border-1 border-[#333] font-bold hover:border-2 hover:border-[#000] hover:bg-white"
                    >
                        Give feedback
                    </Button>
                </section>
            ...
            <div>
                <section className="flex justify-center bg-primary-dark px-56 pb-6 pt-4">
            ...
            <div>
                <section className="flex justify-center bg-primary-dark pb-7 pt-2 text-sm text-white">
